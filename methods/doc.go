// Package methods defines the HTTP methods (also known as HTTP verbs) as constants.
// HTTP methods represent the actions that a client can request from a server when making
// an HTTP request. These methods are fundamental components of RESTful APIs and web interactions.
//
